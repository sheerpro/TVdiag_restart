...
labels = pd.read_csv('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/allgroundtruth.csv')
failure_pre_data: dict = io_util.load('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/pre-data.pkl')
...
io_util.save('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/normal_traces.pkl', normal_traces)
io_util.save('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/normal_metrics.pkl', normal_metrics)
...
normal_traces = io_util.load('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/normal_traces.pkl')
normal_metrics = io_util.load('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/normal_metrics.pkl')
...
ed = time.time()
io_util.save('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/trace-detector.pkl', trace_detectors)
io_util.save('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/metric-detector-strict-host.pkl', metric_detectors)
