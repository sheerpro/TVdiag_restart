...
data: dict = io_util.load('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/post-data-10.pkl')
# 将第一列设置为索引
label_df = pd.read_csv('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/allgroundtruth.csv', index_col=0)

metric_detectors = io_util.load('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/metric-detector-strict-host.pkl')
trace_detectors = io_util.load('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/detector/trace-detector.pkl')
...
io_util.save_json('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/events/log.json', log_events_dic)
io_util.save_json('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/events/metric.json', metric_events_dic)
io_util.save_json('/home/fuxian/lky/TVDiag_new/extractor/AIOPS/events/trace.json', trace_events_dic)
