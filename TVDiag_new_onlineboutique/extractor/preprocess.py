...
labels = pd.read_csv('/home/fuxian/DataSet/NewDataset/ob/allgroundtruth.csv')
failure_pre_data: dict = io_util.load('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/pre-data.pkl')
...
io_util.save('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/detector/normal_traces.pkl', normal_traces)
io_util.save('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/detector/normal_metrics.pkl', normal_metrics)
...
normal_traces = io_util.load('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/detector/normal_traces.pkl')
normal_metrics = io_util.load('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/detector/normal_metrics.pkl')
...
for name, call_dfs in normal_traces.items():
    ...
    for call_df in call_dfs:
        _, durs = slide_window(call_df, 30 * 1000)
        win_size = 30 * 1000
        # print("#######################")
        ...
        # print(f"Code 500 count: {sum(err_500_ps)}")
        # print(f"Code 400 count: {sum(err_400_ps)}")
...
ed = time.time()
io_util.save('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/detector/trace-detector.pkl', trace_detectors)
io_util.save('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/detector/metric-detector-strict-host.pkl', metric_detectors)
