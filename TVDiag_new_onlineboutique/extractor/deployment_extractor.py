...
failure_post_data: dict = io_util.load('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/post-data-10.pkl')
# 将第一列设置为索引
...
for idx, row in tqdm(label_df.iterrows(), total=label_df.shape[0]):
    ...
    # 遍历所有日期目录
    base_dir = '/home/fuxian/DataSet/NewDataset/ob'
...
io_util.save_json('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/events/nodes.json', deployment_nodes)
io_util.save_json('/home/fuxian/lky/TVDiag_new_onlineboutique/extractor/onlineboutique/events/edges.json', deployment_edges)