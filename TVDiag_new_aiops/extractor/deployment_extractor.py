...
failure_post_data: dict = io_util.load('/home/fuxian/lky/TVDiag_new_aiops/extractor/AIOPS/post-data-10.pkl')
# 将第一列设置为索引
...
io_util.save_json('/home/fuxian/lky/TVDiag_new_aiops/extractor/AIOPS/events/nodes.json', deployment_nodes)
io_util.save_json('/home/fuxian/lky/TVDiag_new_aiops/extractor/AIOPS/events/edges.json', deployment_edges)